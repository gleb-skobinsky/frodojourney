...
import com.game.darkforce.app.map.MapObject
...
data class ViewData(
    ...
    infix fun Trooper.isLowerThan(character: GenericCharacter): Boolean =
        character.characterBaseLine(density) < characterBaseLine(density)
